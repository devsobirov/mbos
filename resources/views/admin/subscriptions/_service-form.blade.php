<div class="modal modal-blur fade" id="service-form-{{$item->id}}" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form action="{{route('invoice-item.update-service', $item->id)}}" class="modal-content" method="POST"
              x-data="{status: ''}"
        >
            @csrf
            ...
            <div class="modal-body">
                ...
                @if($item->status == \App\Models\Plan::STATUS_ACTIVE)
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Xizmatni tugatish</span>
                    ...
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Xizmatni bekor qilish</span>
